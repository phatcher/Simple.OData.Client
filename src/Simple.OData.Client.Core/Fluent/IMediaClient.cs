...
namespace Simple.OData.Client
{
    ...
    public interface IMediaClient
    {
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>The media stream converted to byte array.</returns>
        Task<byte[]> GetStreamAsArrayAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>The media stream converted to string.</returns>
        Task<string> GetStreamAsStringAsync(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Task instance.</returns>
        Task SetStreamAsync(Stream stream, string contentType, bool optimisticConcurrency, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Task instance.</returns>
        Task SetStreamAsync(byte[] streamContent, string contentType, bool optimisticConcurrency, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>Task instance.</returns>
        Task SetStreamAsync(string streamContent, bool optimisticConcurrency, CancellationToken cancellationToken = default(CancellationToken));
